...
stored as parquet
location 'alluxio://localhost:19998/s3/store_sales'
tblproperties (
...
stored as parquet
location 'alluxio://localhost:19998/s3/store_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/catalog_sales'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/catalog_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/web_sales'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/web_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/inventory'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/store'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/call_center'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/catalog_page'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/web_site'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/web_page'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/warehouse'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/customer'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/customer_address'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/customer_demographics'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/date_dim'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/household_demographics'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/item'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/income_band'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/promotion'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/reason'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/ship_mode'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 'alluxio://localhost:19998/s3/time_dim'
tblproperties (
  'parquet.compression'='SNAPPY')
;
