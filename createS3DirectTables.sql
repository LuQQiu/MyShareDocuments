...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/store_sales'
tblproperties (
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/store_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/catalog_sales'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/catalog_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/web_sales'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/web_returns'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/inventory'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/store'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/call_center'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/catalog_page'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/web_site'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/web_page'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/warehouse'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/customer'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/customer_address'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/customer_demographics'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/date_dim'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/household_demographics'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/item'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/income_band'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/promotion'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/reason'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/ship_mode'
tblproperties (
  'parquet.compression'='SNAPPY')
;
...
stored as parquet
location 's3a://autobots-tpcds-test-data/parquet/scale100/time_dim'
tblproperties (
  'parquet.compression'='SNAPPY')
;
